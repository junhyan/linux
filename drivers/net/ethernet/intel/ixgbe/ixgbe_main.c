...
char ixgbe_driver_name[] = "ixgbe"; //driver name
...
static struct pci_driver ixgbe_driver = {
	.name     = ixgbe_driver_name,//driver name
	.id_table = ixgbe_pci_tbl, //dev id
	.probe    = ixgbe_probe,//init function
	.remove   = ixgbe_remove,// remove function
#ifdef CONFIG_PM
	.suspend  = ixgbe_suspend,//peer to resume
	.resume   = ixgbe_resume,
#endif
	.shutdown = ixgbe_shutdown,
	.sriov_configure = ixgbe_pci_sriov_configure,//sriov
 ...
 **/
static int __init ixgbe_init_module(void) //init ixgbe driver module
{
	int ret;
	...
	ixgbe_dbg_init();//debug init

	ret = pci_register_driver(&ixgbe_driver);//for pci dev,register driver
	if (ret) {
